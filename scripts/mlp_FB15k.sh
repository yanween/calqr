#!/bin/bash
#SBATCH -J mlp_FB15k-237
#SBATCH --output ../logs/FB15k-237-operation2/mlp_nram_domain_only_pretrain_50w_retrain_e-4.out
#SBATCH -p long
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
export SAVE_PATH=../logs/FB15k-operation2/mlp_nram_domain_only_pretrain_50w_retrain_e-4
export LOG_PATH=../logs/FB15k-operation2/mlp_nram_domain_only_pretrain_50w_retrain_e-4.out
export MODEL=temp
