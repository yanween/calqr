...
export SAVE_PATH=../logs/NELL-q2b-operation2/gqe_nram_domain_only_pretrain_retrain
export LOG_PATH=../logs/NELL-q2b-operation2/gqe_nram_domain_only_pretrain_retrain.out
export MODEL=temp
