#!/bin/bash
#SBATCH -J logice_FB15k
#SBATCH --output ../logs/FB15k-operation2/logice_nram_domain_only_pretrain_retrain.out
#SBATCH -p batch
#SBATCH -N 1
...
export SAVE_PATH=../logs/FB15k-operation2/logice_nram_domain_only_pretrain_retrain
export LOG_PATH=../logs/FB15k-operation2/logice_nram_domain_only_pretrain_retrain.out
export MODEL=temp
