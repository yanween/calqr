#!/bin/bash
#SBATCH -J mlp_NELL_995
#SBATCH --output ../logs/NELL-995-operation2/mlp_nram_domain_only_pretrain_20w_retrain_e-4.out
#SBATCH -p long
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
export SAVE_PATH=../logs/NELL-995-operation2/mlp_nram_domain_only_pretrain_20w_retrain_e-4
export LOG_PATH=../logs/NELL-995-operation2/mlp_nram_domain_only_pretrain_20w_retrain_e-4.out
export MODEL=temp
