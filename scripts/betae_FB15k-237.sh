#!/bin/bash
#SBATCH -J betae_FB15k_PEpoch_100w_TEMP
#SBATCH --output ../logs/FB15k-237-operation2/betae_nram_domain_only_pretrain_100w_retrain_e-4.out
#SBATCH -p long
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
export SAVE_PATH=../logs/FB15k-237-operation2/betae_nram_domain_only_pretrain_100w_retrain_e-4
export LOG_PATH=../logs/FB15k-237-operation2/betae_nram_domain_only_pretrain_100w_retrain_e-4.out
export MODEL=temp
