#!/bin/bash
#SBATCH -J betae_NELL_PEpoch_20w_TEMP
#SBATCH --output ../logs/NELL-995-operation2/betae_nram_domain_only_pretrain_20w_retrain_e-4.out
#SBATCH -p long
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
export SAVE_PATH=../logs/NELL-995-operation2/betae_nram_domain_only_pretrain_20w_retrain_e-4
export LOG_PATH=../logs/NELL-995-operation2/betae_nram_domain_only_pretrain_20w_retrain_e-4.out
export MODEL=temp
...
python -u ../main.py --cuda --do_train --do_valid --do_test --do_pretrain --do_prevalid --do_pretest \
  ...
  --cpu_num 6 --geo beta -betam "(1600,2)" --test_batch_size 16 --tasks "1p.2p.3p.2i.3i.ip.pi.2in.3in.inp.pin.pni.2u.up" --print_on_screen \
